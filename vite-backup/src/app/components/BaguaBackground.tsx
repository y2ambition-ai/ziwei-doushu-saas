export function BaguaBackground({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      {/* Trigram lines (3 strokes per trigram) */}
      ...
      {/* Yin dot (light in dark yang area) */}
      <circle cx={cx} cy={cy - R / 2} r={R / 6} fill="#F7F3EC" />
      {/* Yang dot (dark in light yin area) */}
